                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-control form-select" name="tahun_ajaran">
                                                    ...
                                                    <option value="2024-2025"
                                                        {{ old('tahun_ajaran', $rapor->tahun_ajaran) == '2024-2025' ? 'selected' : '' }}>
                                                        2024-2025</option>
                                                    <option value="2025-2026"
                                                        {{ old('tahun_ajaran', $rapor->tahun_ajaran) == '2025-2026' ? 'selected' : '' }}>
                                                        2025-2026</option>
                                                    <option value="2026-2027"
                                                        {{ old('tahun_ajaran', $rapor->tahun_ajaran) == '2026-2027' ? 'selected' : '' }}>
                                                        2026-2027</option>
                                                    <option value="2027-2028"
                                                        {{ old('tahun_ajaran', $rapor->tahun_ajaran) == '2027-2028' ? 'selected' : '' }}>
                                                        2027-2028</option>
                                                    <option value="2028-2029"
                                                        {{ old('tahun_ajaran', $rapor->tahun_ajaran) == '2028-2029' ? 'selected' : '' }}>
                                                        2028-2029</option>
                                                    <option value="2029-2030"
                                                        {{ old('tahun_ajaran', $rapor->tahun_ajaran) == '2029-2030' ? 'selected' : '' }}>
                                                        2029-2030</option>
                                                </select>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <select class="form-control form-select" name="kelas">
                                                    ...
                                                    <option value="X"
                                                        {{ old('kelas', $rapor->kelas) == 'X' ? 'selected' : '' }}>X
                                                    </option>
                                                    <option value="XI"
                                                        {{ old('kelas', $rapor->kelas) == 'XI' ? 'selected' : '' }}>XI
                                                    </option>
                                                    <option value="XII"
                                                        {{ old('kelas', $rapor->kelas) == 'XII' ? 'selected' : '' }}>XII
                                                    </option>
                                                    <option value="XIII"
                                                        {{ old('kelas', $rapor->kelas) == 'XIII' ? 'selected' : '' }}>XIII
                                                    </option>
                                                </select>
                                            </div>
                                        </div>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-control form-select" name="semester">
                                                    ...
                                                    <option value="1 (Ganjil)"
                                                        {{ old('semester', $rapor->semester) == '1 (Ganjil)' ? 'selected' : '' }}>
                                                        1 (Ganjil)</option>
                                                    <option value="2 (Genap)"
                                                        {{ old('semester', $rapor->semester) == '2 (Genap)' ? 'selected' : '' }}>
                                                        2 (Genap)</option>
                                                </select>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row row-cards">
                                        <div class="col-sm-6 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="attitude[beriman][deskripsi]" id="beriman_deskripsi" class="form-control">{{ old('attitude.beriman.deskripsi', $rapor->attitude['beriman']['deskripsi'] ?? '') }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">Mandiri</label>
                                                <textarea name="attitude[mandiri][deskripsi]" id="mandiri_deskripsi" class="form-control">{{ old('attitude.mandiri.deskripsi', $rapor->attitude['mandiri']['deskripsi'] ?? '') }}</textarea>
                                            </div>
                                        </div>
                                        <div class="col-sm-6 col-md-6">
                                            <div class="mb-3">
                                                <label class="form-label">Bergotong Royong</label>
                                                <textarea name="attitude[gotong_royong][deskripsi]" id="gotong_royong_deskripsi" class="form-control">{{ old('attitude.gotong_royong.deskripsi', $rapor->attitude['gotong_royong']['deskripsi'] ?? '') }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div id="step4">
                                <div class="card-body">
                                    ...
                                    <div class="row row-cards">
                                        ...
                                        <div class="col-sm-6 col-md-4">
                                            <div class="mb-3">
                                                <label for="pai_nilai" class="form-label">Pendidikan Agama dan Budi
                                                    Pekerti</label>
                                        ...
                                        <div class="col-sm-6 col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" name="muatan_nasional[pkn][nilai]" id="pkn_nilai"
                                                    class="form-control"
                                                    value="{{ $rapor->muatan_nasional['pkn']['nilai'] ?? '' }}" required>
                                            </div>
                                        </div>
                                        <!-- Bahasa Indonesia -->
                                        <div class="col-sm-6 col-md-4">
                                        ...
                                        <div class="col-sm-6 col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="muatan_nasional[pai][deskripsi]" id="pai_deskripsi" class="form-control">{{ $rapor->muatan_nasional['pai']['deskripsi'] ?? '' }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="muatan_nasional[pkn][deskripsi]" id="pkn_deskripsi" class="form-control">{{ $rapor->muatan_nasional['pkn']['deskripsi'] ?? '' }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-md-4">
                                            <div class="mb-3">
                                                <label for="bind_deskripsi" class="form-label">Deskripsi Bahasa
                                                    Indonesia</label>
                                                <textarea name="muatan_nasional[bindo][deskripsi]" id="bindo_deskripsi" class="form-control">{{ $rapor->muatan_nasional['bindo']['deskripsi'] ?? '' }}</textarea>
                                            </div>
                                        </div>
                                        <!-- Matematika -->
                                        <div class="col-sm-6 col-md-4">
                                        ...
                                        <div class="col-sm-6 col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="muatan_nasional[mtk][deskripsi]" id="mtk_deskripsi" class="form-control">{{ $rapor->muatan_nasional['mtk']['deskripsi'] ?? '' }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-md-4">
                                            <div class="mb-3">
                                                <label for="sejindo_deskripsi" class="form-label">Deskripsi Sejarah
                                                    Indonesia</label>
                                                <textarea name="muatan_nasional[sejindo][deskripsi]" id="sejindo_deskripsi" class="form-control">{{ $rapor->muatan_nasional['sejindo']['deskripsi'] ?? '' }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-md-4">
                                            <div class="mb-3">
                                                <label for="bhsAsing_deskripsi" class="form-label">Deskripsi Bahasa
                                                    Asing</label>
                                                <textarea name="muatan_nasional[bhsAsing][deskripsi]" id="bhsAsing_deskripsi" class="form-control">{{ $rapor->muatan_nasional['bhsAsing']['deskripsi'] ?? '' }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                        ...
                                        <div class="col-sm-6 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" name="muatan_kewilayahan[sbd][nilai]"
                                                    id="sbd_nilai" class="form-control"
                                        ...
                                        <div class="col-sm-6 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <input type="number" name="muatan_kewilayahan[pjok][nilai]"
                                                    id="pjok_nilai" class="form-control"
                                        ...
                                        <div class="col-sm-6 col-md-6">
                                            <div class="mb-3">
                                                <label for="sbd_deskripsi" class="form-label">Deskripsi Seni
                                                    Budaya</label>
                                                <textarea name="muatan_kewilayahan[sbd][deskripsi]" id="sbd_deskripsi" class="form-control">{{ $rapor->muatan_kewilayahan['sbd']['deskripsi'] ?? '' }}</textarea>
                                            </div>
                                        </div>
                                        <!-- Deskripsi PJOK -->
                                        <div class="col-sm-6 col-md-6">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="muatan_kewilayahan[pjok][deskripsi]" id="pjok_deskripsi" class="form-control">{{ $rapor->muatan_kewilayahan['pjok']['deskripsi'] ?? '' }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row row-cards">
                                        ...
                                        <div class="col-sm-6 col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="muatan_peminatan[simdig][deskripsi]" id="simdig_deskripsi" class="form-control">{{ $rapor->muatan_peminatan['simdig']['deskripsi'] ?? '' }}</textarea>
                                            </div>
                                        </div>
                                        <!-- Deskripsi Fisika -->
                                        <div class="col-sm-6 col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="muatan_peminatan[fisika][deskripsi]" id="fisika_deskripsi" class="form-control">{{ $rapor->muatan_peminatan['fisika']['deskripsi'] ?? '' }}</textarea>
                                            </div>
                                        </div>
                                        <!-- Deskripsi Kimia -->
                                        <div class="col-sm-6 col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="muatan_peminatan[kimia][deskripsi]" id="kimia_deskripsi" class="form-control">{{ $rapor->muatan_peminatan['kimia']['deskripsi'] ?? '' }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row row-cards">
                                        ...
                                        <div class="col-sm-6 col-md-3">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="muatan_peminatan[siskom][deskripsi]" id="siskom_deskripsi" class="form-control">{{ $rapor->muatan_peminatan['siskom']['deskripsi'] ?? '' }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-md-3">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="muatan_peminatan[komjar][deskripsi]" id="komjar_deskripsi" class="form-control">{{ $rapor->muatan_peminatan['komjar']['deskripsi'] ?? '' }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-md-3">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="muatan_peminatan[progdas][deskripsi]" id="progdas_deskripsi" class="form-control">{{ $rapor->muatan_peminatan['progdas']['deskripsi'] ?? '' }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-md-3">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="muatan_peminatan[ddg][deskripsi]" id="ddg_deskripsi" class="form-control">{{ $rapor->muatan_peminatan['ddg']['deskripsi'] ?? '' }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row row-cards">
                                        ...
                                        <div class="col-sm-6 col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="muatan_peminatan[iaas][deskripsi]" id="iaas_deskripsi" class="form-control">{{ $rapor->muatan_peminatan['iaas']['deskripsi'] ?? '' }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="muatan_peminatan[paas][deskripsi]" id="paas_deskripsi" class="form-control">{{ $rapor->muatan_peminatan['paas']['deskripsi'] ?? '' }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="muatan_peminatan[saas][deskripsi]" id="saas_deskripsi" class="form-control">{{ $rapor->muatan_peminatan['saas']['deskripsi'] ?? '' }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="muatan_peminatan[siot][deskripsi]" id="siot_deskripsi" class="form-control">{{ $rapor->muatan_peminatan['siot']['deskripsi'] ?? '' }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="muatan_peminatan[skj][deskripsi]" id="skj_deskripsi" class="form-control">{{ $rapor->muatan_peminatan['skj']['deskripsi'] ?? '' }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-md-4">
                                            <div class="mb-3">
                                                <label class="form-label">Deskripsi Produk Kreatif dan
                                                    Kewirausahaan</label>
                                                <textarea name="muatan_peminatan[pkk][deskripsi]" id="pkk_deskripsi" class="form-control">{{ $rapor->muatan_peminatan['pkk']['deskripsi'] ?? '' }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row row-cards">
                                        ...
                                        <div class="col-sm-6 col-md-3">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="extracurricular[pramuka][deskripsi]" id="pramuka_deskripsi" class="form-control">{{ $rapor->extracurricular['pramuka']['deskripsi'] ?? '' }}</textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6 col-md-3">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="extracurricular[bultang][deskripsi]" id="bulu_tangkis_deskripsi" class="form-control">{{ $rapor->extracurricular['bultang']['deskripsi'] ?? '' }}</textarea>
                                            </div>
                                        </div>
                                        <!-- Deskripsi Futsal -->
                                        <div class="col-sm-6 col-md-3">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="extracurricular[futsal][deskripsi]" id="futsal_deskripsi" class="form-control">{{ $rapor->extracurricular['futsal']['deskripsi'] ?? '' }}</textarea>
                                            </div>
                                        </div>
                                        <!-- Deskripsi Silat -->
                                        <div class="col-sm-6 col-md-3">
                                            <div class="mb-3">
                                                <label class="form-label">Deskripsi Futsal</label>
                                                <textarea name="extracurricular[silat][deskripsi]" id="silat_deskripsi" class="form-control">{{ $rapor->extracurricular['silat']['deskripsi'] ?? '' }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="row row-cards">
                                        ...
                                        <div class="col-sm-6 col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="achievements[one][deskripsi]" id="one_deskripsi" class="form-control">{{ $rapor->achievements['one']['deskripsi'] ?? '' }}</textarea>
                                            </div>
                                        </div>
                                        <!-- Deskripsi 2 -->
                                        <div class="col-sm-6 col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="achievements[two][deskripsi]" id="two_deskripsi" class="form-control">{{ $rapor->achievements['two']['deskripsi'] ?? '' }}</textarea>
                                            </div>
                                        </div>
                                        <!-- Deskripsi 3 -->
                                        <div class="col-sm-6 col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="achievements[three][deskripsi]" id="three_deskripsi" class="form-control">{{ $rapor->achievements['three']['deskripsi'] ?? '' }}</textarea>
                                            </div>
                                        </div>
                                        <!-- Prestasi 4 -->
                                        <div class="col-sm-6 col-md-4">
                                        ...
                                        <div class="col-sm-6 col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="achievements[four][deskripsi]" id="four_deskripsi" class="form-control">{{ $rapor->achievements['four']['deskripsi'] ?? '' }}</textarea>
                                            </div>
                                        </div>
                                        <!-- Deskripsi 5 -->
                                        <div class="col-sm-6 col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="achievements[five][deskripsi]" id="five_deskripsi" class="form-control">{{ $rapor->achievements['five']['deskripsi'] ?? '' }}</textarea>
                                            </div>
                                        </div>
                                        <!-- Deskripsi 6 -->
                                        <div class="col-sm-6 col-md-4">
                                            <div class="mb-3">
                                                ...
                                                <textarea name="achievements[six][deskripsi]" id="six_deskripsi" class="form-control">{{ $rapor->achievements['six']['deskripsi'] ?? '' }}</textarea>
                                            </div>
                                        </div>
                                    </div>
                                </div>
