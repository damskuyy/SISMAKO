                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-control form-select" name="tahun_ajaran">
                                                    ...
                                                    <option value="2024-2025"
                                                        {{ $rpts->tahun_ajaran == '2024-2025' ? 'selected' : '' }}>
                                                        2024-2025</option>
                                                    <option value="2025-2026"
                                                        {{ $rpts->tahun_ajaran == '2025-2026' ? 'selected' : '' }}>
                                                        2025-2026</option>
                                                    <option value="2026-2027"
                                                        {{ $rpts->tahun_ajaran == '2026-2027' ? 'selected' : '' }}>
                                                        2026-2027</option>
                                                    <option value="2027-2028"
                                                        {{ $rpts->tahun_ajaran == '2027-2028' ? 'selected' : '' }}>
                                                        2027-2028</option>
                                                    <option value="2028-2029"
                                                        {{ $rpts->tahun_ajaran == '2028-2029' ? 'selected' : '' }}>
                                                        2028-2029</option>
                                                    <option value="2029-2030"
                                                        {{ $rpts->tahun_ajaran == '2029-2030' ? 'selected' : '' }}>
                                                        2029-2030</option>
                                                </select>
                                                @error('tahun_ajaran')
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-control form-select" name="kelas">
                                                    ...
                                                    <option value="X" {{ $rpts->kelas == 'X' ? 'selected' : '' }}>
                                                        X</option>
                                                    <option value="XI"
                                                        {{ $rpts->kelas == 'XI' ? 'selected' : '' }}>XI</option>
                                                    <option value="XII"
                                                        {{ $rpts->kelas == 'XII' ? 'selected' : '' }}>XII</option>
                                                    <option value="XIII"
                                                        {{ $rpts->kelas == 'XIII' ? 'selected' : '' }}>XIII</option>
                                                </select>
                                                @error('kelas')
                                                    <div class="text-danger mt-2"> {{ $message }} </div>
                                                @enderror
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <select class="form-control form-select" name="semester">
                                                    ...
                                                    <option value="1 (Ganjil)"
                                                        {{ $rpts->semester == '1 (Ganjil)' ? 'selected' : '' }}>1
                                                        (Ganjil)</option>
                                                    <option value="2 (Genap)"
                                                        {{ $rpts->semester == '2 (Genap)' ? 'selected' : '' }}>2
                                                        (Genap)</option>
                                                </select>
                                                @error('semester')
                                                    <div class="text-danger mt-2"> {{ $message }} </div>
