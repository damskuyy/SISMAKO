            ...
            <div class="col">
                <div class="row row-cards">
                    <div class="col-12">
                        ...
                        <form class="card" action="{{ route('pas.perform') }}" method="POST" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body">
                                ...
                                <div class="row row-cards">
                                    ...
                                    @foreach(['kisi_kisi', 'soal', 'jawaban', 'proker', 'kehadiran', 'ba', 'sk_panitia', 'tatib', 'surat_pemberitahuan', 'jadwal', 'daftar_nilai', 'tanda_terima_dan_penerimaan_soal', 'kehadiran_panitia'] as $file)
