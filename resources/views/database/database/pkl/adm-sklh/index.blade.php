    ...
    <div class="container mt-3">
        <div class="row">
            <div class="col-lg-4">
                ...
                <a href="{{ route('pkl.sekolah.create') }}" class="btn btn-primary">Tambah Data Adminstrasi Sekolah</a>
            </div>
        </div>
    </div>
        ...
        <div class="table-responsive shadow shadow-sm" style="margin-right: 20px; margin-left: 20px">
            <table class="table card-table table-vcenter text-nowrap datatable">
                ...
                <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-list flex-nowrap">
                                    <button class="btn rounded bg-success"><a href="{{route('file.pkl.sekolah', $data->id)}}"><i
                                                class="bi bi-box-arrow-right text-white"></i></a></button>
                                    <button class="btn rounded bg-yellow"><a
                                            href="{{ route('pkl.sekolah.edit', $data->id) }}"><i
                                                class="bi bi-pencil-square text-white"></i></a></button>
                                    <button type="button" class="btn btn-danger"
                                        onclick="openDeleteModal('{{ route('pkl.sekolah.destroy', $data->id) }}')">
                    ...
                    @empty
                        <tr>
                            <td colspan="7" style="text-align: center">Tidak ada data perusahaan yang tersedia.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
