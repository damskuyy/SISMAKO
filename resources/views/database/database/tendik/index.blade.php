...
@section('content')
    ...
    <div class="container mt-3">
        ...
        <a href="{{ route('tendik.create') }}" class="btn btn-primary">Tambah data Tendik</a>
    </div>
    <div class="mt-4">
        <div class="table-responsive shadow shadow-sm" style="margin-right: 20px; margin-left: 20px">
            <table class="table card-table table-vcenter text-nowrap datatable">
                ...
                <tbody>
                    ...
                    @empty
                        <tr>
                            <td colspan="13" style="text-align: center">Tidak ada data tendik yang tersedia.</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
