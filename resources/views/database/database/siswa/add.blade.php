                ...
                <div class="row">
                    <div class="col-12 mb-3">
                        <div>
                            ...
                            <input autocomplete="off" type="number" class="form-control" name="no_hp_wali" value="{{old('no_hp_wali')}}" placeholder="6289533557657">
                            @error('no_hp_wali')
                                <div class="text-danger mt-2">{{$message}}</div>
                            @enderror
                        </div>
                ...
                <div class="row">
                    <div class="col-lg-3">
                        <div class="mb-3">
                            ...
                            <select class="form-control" name="diterima_di_kelas" value="{{old('diterima_di_kelas')}}">
                ...
                <div class="row">
                    <div class="col-lg-6 mb-3">
                        ...
                        <div class="input-group">
                            <input type="file" class="form-control" name="foto_kelas10" accept=".png">
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <div class="input-group">
                            <input type="file" class="form-control" name="foto_kelas11" accept=".png">
                            <div class="input-group-append">
                    ...
                    <div class="col-lg-12 mb-3">
                        ...
                        <div class="input-group">
                            <input type="file" class="form-control" name="foto_kelas12" accept=".png">
                            <div class="input-group-append">
            ...
            <div id="step-5" class="d-none border p-3 rounded-3">
                ...
                <div class="row">
                    <div class="col-lg-6 mb-3">
                        ...
                        <div class="input-group">
                            <input type="file" class="form-control" name="rapot_kelas7" accept=".png">
                            <div class="input-group-append">
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <div class="input-group">
                            <input type="file" class="form-control" name="rapot_kelas8" accept=".png">
                            <div class="input-group-append">
                    ...
                    <div class="col-lg-12 mb-3">
                        ...
                        <div class="input-group">
                            <input type="file" class="form-control" name="rapot_kelas9" accept=".png">
                            <div class="input-group-append">
            ...
            <div id="step-6" class="d-none border p-3 rounded-3">
                <div class="row">
                    <div class="col-lg-6 mb-3">
                        ...
                        <div class="input-group">
                            <input type="file" class="form-control" name="ijazah" accept=".png" onchange="handleFileUpload(event, 'ijazah')">
                            <div class="input-group-append">
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <div class="input-group">
                            <input type="file" class="form-control" name="surat_Kelulusan" accept=".png" onchange="handleFileUpload(event, 'surat_Kelulusan')">
                            <div class="input-group-append">
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <div class="input-group">
                            <input type="file" class="form-control" name="kk" accept=".png" onchange="handleFileUpload(event, 'kk')">
                            <div class="input-group-append">
                    ...
                    <div class="col-lg-6 mb-3">
                        ...
                        <div class="input-group">
                            <input type="file" class="form-control" name="akta_kelahiran" accept=".png" onchange="handleFileUpload(event, 'akta_kelahiran')">
                            <div class="input-group-append">
                    ...
                    <div class="col-lg-12 mb-3">
                        ...
                        <div class="input-group">
                            <input type="file" class="form-control" name="surat_pernyataan_calonPesertaDidik" accept=".png" onchange="handleFileUpload(event, 'surat_pernyataan_calonPesertaDidik')">
                            <div class="input-group-append">
                    ...
                    <div class="col-lg-12 mb-3">
                        ...
                        <div class="input-group">
                            <input type="file" class="form-control" name="surat_pernyataan_wali" accept=".png" onchange="handleFileUpload(event, 'surat_pernyataan_wali')">
                            <div class="input-group-append">
                    ...
                    <div class="col-lg-12 mb-3">
                        ...
                        <div class="input-group">
                            <input type="file" class="form-control" name="surat_pernyataan_tidak_merokok" accept=".png" onchange="handleFileUpload(event, 'surat_pernyataan_tidak_merokok')">
                            <div class="input-group-append">
