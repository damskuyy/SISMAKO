            ...
            <div class="card">
                ...
                <div class="card-footer ">
                    ...
                    <div class="text-end">
                        ...
                        <button id="submitButton" class="btn btn-primary" data-bs-toggle="modal" disabled>Input</button>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="col-12">
        <div class="card">
            <div class="table-responsive p-3">
                <table class="table card-table table-vcenter text-nowrap datatable" style="width: 100%" id="myTable1">
                    <thead>
                        <tr>
                            <th>Tahun ajaran</th>
                            <th>Tanggal</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <button type="button" class="btn btn-icon btn-sm btn-outline-success" role="button"
                                        data-bs-target="#modalUpdate1{{ $item->id }}" data-bs-toggle="modal"
...
<div class="container-view2 container-xl" id="view2" hidden>
    ...
    <div class="col-12">
        <div class="card">
            <div class="table-responsive p-3">
                <table class="table card-table table-vcenter text-nowrap datatable" style="width: 100%" id="myTable2">
                    <thead>
                        <tr>
                            <th>Tahun ajaran</th>
                            {{-- <th>Tanggal</th> --}}
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <button type="button" class="btn btn-icon btn-sm btn-outline-success" role="button"
                                        data-bs-target="#modalUpdate2{{ $item->id }}" data-bs-toggle="modal"
                                        data-bs-dismiss="modal">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round"
...
<div class="container-view3 container-xl" id="view3" hidden>
    ...
    <div class="col-12">
        <div class="card">
            <div class="table-responsive p-3">
                <table class="table card-table table-vcenter text-nowrap datatable" style="width: 100%" id="myTable3">
                    <thead>
                        <tr>
                            <th>Tahun ajaran</th>
                            <th>Tanggal</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <button type="button" class="btn btn-icon btn-sm btn-outline-success" role="button"
                                        data-bs-target="#modalUpdate3{{ $item->id }}" data-bs-toggle="modal"
                                        data-bs-dismiss="modal">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round"
...
<div class="container-view4 container-xl" id="view4" hidden>
    ...
    <div class="col-12">
        <div class="card">
            <div class="table-responsive p-3">
                <table class="table card-table table-vcenter text-nowrap datatable" style="width: 100%" id="myTable4">
                    <thead>
                        <tr>
                            <th>Tahun ajaran</th>
                            <th>Tanggal</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <button type="button" class="btn btn-icon btn-sm btn-outline-success" role="button"
                                        data-bs-target="#modalUpdate4{{ $item->id }}" data-bs-toggle="modal"
                                        data-bs-dismiss="modal">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round"
...
<div class="container-view5 container-xl" id="view5" hidden>
    <div class="col-12">
        <div class="card">
            <div class="table-responsive p-3">
                <table class="table card-table table-vcenter text-nowrap datatable" style="width: 100%" id="myTable5">
                    <thead>
                        <tr>
                            <th>Tahun ajaran</th>
                            <th>Tanggal</th>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <button type="button" class="btn btn-icon btn-sm btn-outline-success" role="button"
                                        data-bs-target="#modalUpdate5{{ $item->id }}" data-bs-toggle="modal"
                                        data-bs-dismiss="modal">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round"
...
<div class="container-view6 container-xl" id="view6" hidden>
    ...
    <div class="col-12">
        <div class="card">
            <div class="table-responsive p-3">
                <table class="table card-table table-vcenter text-nowrap datatable" style="width: 100%" id="myTable6">
                    <thead>
                        <tr>
                            <th>Tahun ajaran</th>
                            {{-- <th>Tanggal</th> --}}
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="btn-group">
                                    ...
                                    <button type="button" class="btn btn-icon btn-sm btn-outline-success" role="button"
                                        data-bs-target="#modalUpdate6{{ $item->id }}" data-bs-toggle="modal"
                                        data-bs-dismiss="modal">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                            viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2"
                                            stroke-linecap="round" stroke-linejoin="round"
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            ...
                            <select id="tp-modal-3" class="form-select" name="tp">
                                ...
                                <option value="2022/2023" {{ old('tp', $item->tp) == '2022/2023' ? 'selected' : ''
                                    }}>2022/2023
                                </option>
                                <option value="2023/2024" {{ old('tp', $item->tp) == '2023/2024' ? 'selected' : ''
                                    }}>2023/2024
                                </option>
                                <option value="2024/2025" {{ old('tp', $item->tp) == '2024/2025' ? 'selected' : ''
                                    }}>2024/2025
                                </option>
                                <option value="2025/2026" {{ old('tp', $item->tp) == '2025/2026' ? 'selected' : ''
                                    }}>2025/2026
                                </option>
                                <option value="2026/2027" {{ old('tp', $item->tp) == '2026/2027' ? 'selected' : ''
                                    }}>2026/2027
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="col-6">
                            ...
                            <div class="input-icon mb-2">
                                <input class="form-control " placeholder="Select a date" id="datepicker" name="tanggal"
                                    autocomplete="false" value="{{ old('tanggal', $item->tanggal) }}">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" id="no_surat6" name="no_surat"
                                    placeholder="Kolom wajib diisi" value="{{ old('no_surat', $item->no_surat) }}">
                            </div>
                            @error('no_surat')
                            <div class="text-danger">{{ $message }}</div>
                            @enderror
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="perihal" placeholder="Kolom wajib diisi"
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="dari" placeholder="Kolom wajib diisi"
                ...
                <div class="modal-body">
                    <div class="col-12">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="lainnya-update-1" class="form-control" name="jenis_surat"
    ...
    <form action="{{ route('outbox.update', $item->id) }}" method="POST" enctype="multipart/form-data">
        ...
        <div class="modal-dialog modal-lg modal-dialog-centered" role="document">
            <div class="modal-content">
                        ...
                        <div class="col-6">
                            ...
                            <div class="input-icon mb-2">
                                <input class="form-control " placeholder="Select a date" id="datepicker-2"
                                    name="tanggal" autocomplete="false" value="{{ old('tanggal', $item->tanggal) }}">
                                <span class="input-icon-addon">
                                    <!-- Download SVG icon from http://tabler-icons.io/i/calendar -->
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24"
                                        viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="kepada" placeholder="Kolom wajib diisi"
                ...
                <div class="modal-body">
                    <div class="col-12">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" id="lainnya-update-2" class="form-control" name="jenis_surat"
                                placeholder="Masukkan jenis surat lainnya" disabled>
                        </div>
                    </div>
                </div>
                <div class="modal-footer text-end">
                    <div class="d-flex">
                        <a href="{{ route('inbox.index') }}" class="btn btn-link" data-bs-dismiss="modal">Cancel</a>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="input-icon mb-2">
                                <input class="form-control" placeholder="Select a date" name="tanggal" id="datepicker"
                                    autocomplete="false" value="{{ old('tanggal', $item->tanggal) }}">
                                <span class="input-icon-addon">
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24"
                                        viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                        ...
                        <div class="col-6">
                            <label class="form-selectgroup-item flex-fill">
                                <input type="radio" name="subjek" value="siswa"
                                    class="form-selectgroup-input radio-inbox7" {{ old('subjek', $item->subjek) ==
                                'siswa' ? 'checked' : '' }}>
                                <div class="form-selectgroup-label d-flex align-items-center p-3">
                                    <div class="me-3">
                        ...
                        <div class="col-6">
                            <label class="form-selectgroup-item flex-fill">
                                <input type="radio" name="subjek" value="guru"
                                    class="form-selectgroup-input radio-inbox8" {{ old('subjek', $item->subjek) ==
                                'guru' ? 'checked' : '' }}>
                                <div class="form-selectgroup-label d-flex align-items-center p-3">
                                    <div class="me-3">
                                        <span class="form-selectgroup-check"></span>
                            ...
                            <input type="text" class="form-control mt-3" name="guru" placeholder="Masukan nama guru...."
                                value="{{ old('guru', $item->guru) }}" {{ old('subjek', $item->subjek) != 'guru' ?
                            'disabled' : '' }}>
                        </div>
                    </div>
                </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="alasan" placeholder="Kolom wajib diisi"
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <select id="sp" class="form-select" name="sp">
                                    ...
                                    <option value="sp1" {{ old('sp', $item->sp) == 'sp1' ? 'selected' : '' }}>
                                        1 (Satu)</option>
                                    <option value="sp2" {{ old('sp', $item->sp) == 'sp2' ? 'selected' : '' }}>
                                        2 (Dua)</option>
                                    <option value="sp3" {{ old('sp', $item->sp) == 'sp3' ? 'selected' : '' }}>
                                        3 (Tiga)</option>
                                </select>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <textarea class="form-control" name="keterangan" rows="6"
                                    placeholder="Isi Keterangan..">{{ old('keterangan', $item->keterangan) }}</textarea>
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="col-6">
                            <div class="input-icon mb-2">
                                <input class="form-control " placeholder="Select a date" id="datepicker"
                                    autocomplete="false" name="tanggal" value="{{ old('tanggal', $item->tanggal) }}">
                                <span class="input-icon-addon">
                                    <!-- Download SVG icon from http://tabler-icons.io/i/calendar -->
                                    <svg xmlns="http://www.w3.org/2000/svg" class="icon" width="24" height="24"
                                        viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none"
                    ...
                    <div class="row">
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="keperluan" placeholder="Kolom wajib diisi"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body p-3 ">
                    ...
                    <div class="row ">
                        ...
                        <div class="col-6">
                            <input type="text" id="time-input" class="form-control" placeholder="00:00-00:00"
                                autocomplete="off" name="waktu" value="{{ old('waktu', $item->waktu) }}">
                        </div>
                        <div class="col-6">
                            <div class="mb-3">
                                <select class="form-select" name="daring">
                                    <option value="" selected>Off/On</option>
                                    <option value="Offline" {{ old('daring', $item->daring) == 'Offline' ? 'selected' :
                                        '' }}>Offline</option>
                                    <option value="Online" {{ old('daring', $item->daring) == 'Online' ? 'selected' : ''
                                        }}>Online</option>
                                </select>
                            </div>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="materi" placeholder="Kolom wajib diisi"
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="hasil" placeholder="Kolom wajib diisi"
                                    value="{{ old('hasil', $item->hasil) }}">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <textarea rows="5" class="form-control" placeholder="Here can be your description"
                                    name="peserta">{{ old('peserta', $item->peserta) }}</textarea>
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="mb-3">
                                ...
                                <textarea rows="5" class="form-control" placeholder="Here can be your description"
                                    name="hasil_lainnya">{{ old('hasil_lainnya', $item->hasil) }}</textarea>
                            </div>
                        </div>
                    </div>
                    <div class="row">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-6">
                            <div class="mb-3">
                                <label class="form-label ">No. Surat</label>
                                <input type="text" class="form-control" name="no_surat" placeholder="Kolom wajib diisi"
                        ...
                        <div class="col-6">
                            <div class="mb-3">
                                ...
                                <input type="text" class="form-control nominal" id="nominal" name="nominal"
                                    value="{{ old('nominal', $item->nominal) }}" placeholder="Kolom wajib diisi">
                            </div>
                        </div>
                        <div class="col-12">
                            <div class="mb-3">
