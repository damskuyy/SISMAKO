                    ...
                    <form class="card" action="{{ route('mapel.store') }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row row-cards">
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <textarea class="form-control" name="capaian_pembelajaran" rows="4"></textarea>
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <textarea class="form-control" name="tp_atp" rows="4"></textarea>
                                        @error('tp_atp')
                                        <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <textarea class="form-control" name="kktp" rows="4"></textarea>
                                        @error('kktp')
                                        <div class="text-danger">{{ $message }}</div>
                                        @enderror
                                    </div>
                        ...
                        <div id="step3">
                            ...
                            <div class="card-body">
                                ...
                                <div class="row row-cards">
                                    <div class="col-md-4 mb-3">
                                        <label class="form-label fw-bold">Kode Etik</label>
                                        <div class="input-group">
                                            <input type="file" class="form-control" name="kode_etik">
                                            <div class="input-group-append">
                                                <button type="button" class="btn" style="height: 100%"
                                    ...
                                    <div class="col-md-4 mb-3">
                                        <label class="form-label fw-bold">Kalender Akademik</label>
                                        <div class="input-group">
                                            <input type="file" class="form-control" name="kaldik_sekolah">
                                            <div class="input-group-append">
                                                <button type="button" class="btn" style="height: 100%"
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="file" class="form-control" name="pembiasaan_guru">
                                            <div class="input-group-append">
                                                <button type="button" class="btn" style="height: 100%"
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="file" class="form-control" name="alokasi_waktu">
                                            <div class="input-group-append">
                                                <button type="button" class="btn" style="height: 100%"
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="file" class="form-control" name="program_tahunan">
                                            <div class="input-group-append">
                                                <button type="button" class="btn" style="height: 100%"
                                    ...
                                    <div class="col-md-4 mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="file" class="form-control" name="program_semester">
                                            <div class="input-group-append">
                                                <button type="button" class="btn" style="height: 100%"
                            ...
                            <div class="card-body">
                                ...
                                <div class="row row-cards">
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="file" class="form-control" name="penilaian_sikap">
                                            <div class="input-group-append">
                                                <button type="button" class="btn" style="height: 100%"
                                    ...
                                    <div class="col-md-6 mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="file" class="form-control" name="program_remedial">
                                            <div class="input-group-append">
                                                <button type="button" class="btn" style="height: 100%"
