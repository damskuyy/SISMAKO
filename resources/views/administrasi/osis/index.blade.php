    ...
    <div class="px-5 py-4">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="d-flex justify-content-center mb-3">
                <a href="{{ route('osis.index') }}" class="btn btn-secondary">Reset Filters</a>
            </div>
            <form method="GET" action="{{ route('osis.index') }}" class="mb-3">
                                        ...
                                        @foreach ($osis as $item)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    <form action="{{ route('osis.destroy', $item->id) }}" method="POST"
