                    ...
                    <div class="mb-4">
                        <div class="col-12 row">
                            ...
                            <div class="mb-4 col d-flex justify-content-end">
                                <a href="{{ route('eventual.create') }}" class="btn btn-primary">
                                    Tambah
                                </a>
                            </div>
                            @if (session('success'))
                                ...
                                <tbody>
                                    @forelse ($eventual as $item)
                                        <tr>
                                            ...
                                            <td>
                                                <a href="{{ route('eventual.edit', $item->id) }}">
                                                    <i
                                                    class="fa-regular fa-pen-to-square text-white text-xl bg-yellow p-2 rounded-lg"></i>                                                </a>
                                            </td>
                                            <td>
        ...
        <div class="modal modal-blur fade" id="modal-danger-{{ $item->id }}" tabindex="-1" role="dialog" aria-hidden="true">
            <div class="modal-dialog modal-sm modal-dialog-centered" role="document">
                <div class="modal-content">
                    ...
                    <form action="{{ route('eventual.delete', $item->id) }}" method="post">
                        @csrf
                        @method('DELETE')
