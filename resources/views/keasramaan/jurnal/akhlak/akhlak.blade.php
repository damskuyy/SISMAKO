            ...
            <div class="col-12">
                <div class="mb-4">
                    <div class="col-12 row">
                        ...
                        <div class="mb-4 col d-flex justify-content-end">
                            <a href="{{ route('akhlak.create') }}" class="btn btn-primary">
                                Tambah
                            </a>
                        </div>
                        @if (session('success'))
                ...
                <div class="card">
                        ...
                        <table class="table table-vcenter table-mobile-md card-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $item->materi }}</td>
                                    <td>
                                        <a href="{{ route('akhlak.edit', $item->id) }}">
                                            <i
                    ...
                    <div class="d-flex justify-content-center mt-4">
                        {{ $akhlak->links('vendor.pagination.bootstrap-5') }} <!-- Tambahkan ini untuk menampilkan tautan pagination -->
                    </div>
                </div>
            </div>
        </div>
...
{{-- Danger Modal --}}
@foreach ($akhlak as $item)
<form action="{{ route('akhlak.delete', $item->id) }}" method="post">
    @csrf
    @method('DELETE')
