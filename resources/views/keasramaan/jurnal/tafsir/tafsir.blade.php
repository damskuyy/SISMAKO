            ...
            <div class="col-12">
                <div class="mb-4">
                    <div class="col-12 row">
                        ...
                        <div class="mb-4 col d-flex justify-content-end">
                            <a href="{{ route('tafsir.create') }}" class="btn btn-primary">
                                Tambah
                            </a>
                        </div>
                        <form method="GET" action="{{ route('tafsir.index') }}" class="mb-4">
                            <div class="row">
                                <div class="col-md-3">
                ...
                <div class="card">
                        ...
                        <table class="table table-vcenter table-mobile-md card-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $item->materi }}</td>
                                    <td>
                                        <a href="{{ route('tafsir.edit', $item->id) }}">
                                            <i
                    ...
                    <div class="d-flex justify-content-center mt-4">
                        {{ $tafsir->links('vendor.pagination.bootstrap-5') }} <!-- Tambahkan ini untuk menampilkan tautan pagination -->
                    </div>
                </div>
            </div>
        </div>
...
<form action="{{ route('tafsir.delete', $item->id) }}" method="post">
    @csrf
    @method('DELETE')
