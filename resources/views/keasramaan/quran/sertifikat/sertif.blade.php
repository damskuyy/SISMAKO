            ...
            <div class="col-12">
                <div class="mb-4">
                    <div class="col-12 row">
                        ...
                        <form method="GET" action="{{ route('sertifikat') }}">
                            <div class="row">
                                <div class="col-md-3">
                        ...
                        <table class="table table-vcenter table-mobile-md card-table">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{!! Str::limit(Str::afterLast($item->juz_30, '/'), 10, ' ...') !!}</td>
                                    <td>{!! Str::limit(Str::afterLast($item->juz_29, '/'), 10, ' ...') !!}</td>
                                    <td>{!! Str::limit(Str::afterLast($item->juz_28, '/'), 10, ' ...') !!}</td>
                                    <td>{!! Str::limit(Str::afterLast($item->juz_umum, '/'), 10, ' ...') !!}</td>
                                    <td>
