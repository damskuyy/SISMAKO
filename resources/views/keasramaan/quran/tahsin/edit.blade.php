                                ...
                                <div class="col-sm-3 col-md-6">
                                    <div class="mb-3">
                                        ...
                                        <select class="form-control form-select" name="predikat" required>
                                            ...
                                            <option value="Sempurna" {{ (old('predikat') ?? $tahsin->predikat) ==
                                                'Sempurna' ? 'selected' : '' }}>Sempurna
                                            </option>
                                            <option value="Baik" {{ (old('predikat') ?? $tahsin->predikat) == 'Baik' ?
                                                'selected' : '' }}>Baik
                                            </option>
                                            <option value="Cukup" {{ (old('predikat') ?? $tahsin->predikat) == 'Cukup' ?
                                                'selected' : '' }}>Cukup
                                            </option>
                                        </select>
