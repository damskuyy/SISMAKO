            ...
            <div class="col-12">
                <div class="mb-4">
                    <div class="col-12 row">
                        ...
                        <!-- Form Filter -->
                        <form method="GET" action="{{ route('dinas') }}" class="mb-4">
                            <div class="row">
                                <div class="col-md-3">
                ...
                <div class="card">
                    ...
                    <div class="d-flex justify-content-center mt-4">
                        {{ $dinas->appends(request()->input())->links('vendor.pagination.bootstrap-5') }}
                    </div>
                </div>
            </div>
        </div>
...
<form action="{{ route('dinas.delete', $item->id) }}" method="post">
    @csrf
    @method('DELETE')
