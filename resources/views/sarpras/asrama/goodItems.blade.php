                        ...
                        <div class="modal-body">
                            <form id="addItemForm" action="" method="POST">
                                ...
                                <div class="mb-3">
                                    ...
                                    <select class="form-control" id="dorm_purchase_id" name="dorm_purchase_id" required>
                        ...
                        <div class="table-responsive">
                            <table class="table table-vcenter card-table">
                                ...
                                <tbody>
                                    @php
                                        $i = 1;
                                        $filteredDormPurchases = $dormPurchases->filter(function ($item) {
                                            return $item->jumlah_baik > 0;
                                        });
                                    @endphp
                                    @if ($filteredDormPurchases->isNotEmpty())
                                        @foreach ($filteredDormPurchases as $item)
                                            <tr>
                                                <td>{{ $i++ }}</td>
