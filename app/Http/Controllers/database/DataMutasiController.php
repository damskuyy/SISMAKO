...
use App\Models\database\DataMutasi;
use Illuminate\Support\Facades\View;
use App\Http\Controllers\Controller;
use App\Http\Requests\database\MutasiRequest;
...
class DataMutasiController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('database.database.mutasi.index', compact('dataMutasi', 'mutasiFilter', 'statusFilter'));
    }
    ...
    public function exportPdf(Request $request)
    {
        ...
        $html = View::make('database.template.dataMutasi', compact('dataMutasi'))->render();
    ...
    {
        //
        return view('database.database.mutasi.add');
    }
    ...
    public function edit($id)
    {
        ...
        return view('database.database.mutasi.edit', compact('dataMutasi'));
    }
