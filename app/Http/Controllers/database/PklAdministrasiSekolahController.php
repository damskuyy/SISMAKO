...
use App\Http\Requests\database\PklAdminSekolahRequest;
...
class PklAdministrasiSekolahController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        public function sekolah() {
            ...
            return view('database.database.pkl.adm-sklh.index', compact('dataPklSekolah'));
        }
        ...
        public function create()
        {
            ...
            return view('database.database.pkl.adm-sklh.add');
        }
        ...
        public function edit($id)
        {
            ...
            return view('database.database.pkl.adm-sklh.edit', compact('data'));
        ...
        public function update(PklAdminSekolahRequest $request, $id)
        {
            ...
            // Update data di database.database
