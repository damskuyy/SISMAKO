...
class KepalaLabkomController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('administrasi.kepalaLabKom.index', compact('kepalaLabKom', 'tahunAjaranFilter', 'tahunAjaranOptions'));
    }
    ...
    {
        return view('administrasi.kepalaLabKom.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('administrasi.kepalaLabKom.edit', compact('kepalaLabKom'));
    }
