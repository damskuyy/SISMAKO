...
class PerpustakaanController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('administrasi.perpustakaan.index', compact('perpustakaan', 'tahunAjaranOptions', 'tahunAjaranFilter'));
    }
    ...
    {
        return view('administrasi.perpustakaan.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('administrasi.perpustakaan.edit', compact('perpustakaan'));
    }
