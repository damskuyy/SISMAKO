...
class WaliKelasController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('administrasi.walas.index', compact('walas', 'tahunAjaranOptions', 'tahunAjaranFilter'));
    }
    ...
    {
        return view('administrasi.walas.create');
    }
    ...
    public function edit($id)
    {
        ...
        return view('administrasi.walas.edit', compact('walas'));
    }
